...
/**
 * TextAnimate — A text animation component supporting multiple animation presets.
 * Adapted from Magic UI (MIT License) for use with framer-motion.
 *
 * Animations: fadeIn, blurIn, blurInUp, blurInDown, slideUp, slideDown, slideLeft, slideRight, scaleUp, scaleDown
...
const TextAnimateBase = ({
  ...
  const MotionComponent = Component === "h1" ? motion.h1
